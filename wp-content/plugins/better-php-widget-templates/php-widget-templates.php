		...
		function form($instance)
			{
				...
				foreach (glob($child_directory.DS.'widget-*.php') as $filename) {
					$name = pathinfo($filename, PATHINFO_BASENAME);
					$files[$name] = $name;
				}
				
				foreach (glob($parent_directory.DS.'widget-*.php') as $filename) {
					$name = pathinfo($filename, PATHINFO_BASENAME);
					$files[$name] = $name;
				}					
				?>
			...
			function widget($args, $instance)
			{
				...
				if ($template_file && file_exists(get_template_directory().DS.$template_file))
					include get_template_directory().DS.$template_file;				
